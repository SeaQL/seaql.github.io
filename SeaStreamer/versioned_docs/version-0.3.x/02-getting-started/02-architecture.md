...
This is very similar to `sea-streamer-stdio`, but the difference is Stdio works in real-time,
while `sea-streamer-file` works in real-time and replay. That means, File has the ability to
