...
If you're eager to upgrade, let's walk through the changes you're likely to encounter, full list of changes can be found [here](https://github.com/SeaQL/sea-orm/blob/master/CHANGELOG.md#breaking-changes).
