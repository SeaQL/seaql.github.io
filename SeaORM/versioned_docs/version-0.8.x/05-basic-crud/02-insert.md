...
You can check whether any field in an `ActiveModel` is `Set` with the [`is_changed`](https://docs.rs/sea-orm/0.8/sea_orm/entity/prelude/trait.ActiveModelTrait.html#method.is_changed) method.
