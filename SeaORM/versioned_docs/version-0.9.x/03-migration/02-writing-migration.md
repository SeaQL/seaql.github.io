...
At times, you might want to use the [`create_*_from_entity`](https://www.sea-ql.org/SeaORM/docs/generate-sea-query-statement/create-table/) methods to bootstrap your database with several hand written entity files.
