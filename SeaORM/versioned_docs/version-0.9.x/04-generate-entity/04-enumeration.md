...
You can implement [`ActiveEnum`](https://docs.rs/sea-orm/0.9/sea_orm/entity/trait.ActiveEnum.html) manually by hand or use the derive macro [`DeriveActiveEnum`](https://docs.rs/sea-orm/0.9/sea_orm/derive.DeriveActiveEnum.html).

### Derive Implementation

See [`DeriveActiveEnum`](https://docs.rs/sea-orm/0.9/sea_orm/derive.DeriveActiveEnum.html) for the full specification of macro attributes.
