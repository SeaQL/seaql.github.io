...
In previous section, we introduced the [`Linked`](https://docs.rs/sea-orm/0.9/sea_orm/entity/trait.Linked.html) trait. It can also help you define self referencing relations.
