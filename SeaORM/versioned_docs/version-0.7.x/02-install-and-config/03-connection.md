...
To obtain a database connection, use the [`Database`](https://docs.rs/sea-orm/0.7/sea_orm/struct.Database.html) interface:
...
Under the hood, a [`sqlx::Pool`](https://docs.rs/sqlx/0.5/sqlx/struct.Pool.html) is created and owned by [`DatabaseConnection`](https://docs.rs/sea-orm/0.7/sea_orm/enum.DatabaseConnection.html).
...
To configure the connection, use the [`ConnectOptions`](https://docs.rs/sea-orm/0.7/sea_orm/struct.ConnectOptions.html) interface:
