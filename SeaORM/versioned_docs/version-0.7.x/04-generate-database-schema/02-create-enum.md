...
You can generate SQL statement to create database tables with enum columns via the [`Schema`](https://docs.rs/sea-orm/0.7/sea_orm/schema/struct.Schema.html) helper struct.
...
Enum in PostgreSQL is defined as a custom type, it can be created from an `Entity` with the [`Schema::create_enum_from_entity`](https://docs.rs/sea-orm/0.7/sea_orm/schema/struct.Schema.html#method.create_enum_from_entity) method.

You can also create it directly from `ActiveEnum` with the [`Schema::create_enum_from_active_enum`](https://docs.rs/sea-orm/0.7/sea_orm/schema/struct.Schema.html#method.create_enum_from_active_enum) method.
...
In MySQL, enum is defined on table creation so you only need the [`Schema::create_table_from_entity`](https://docs.rs/sea-orm/0.7/sea_orm/schema/struct.Schema.html#method.create_table_from_entity) method.
