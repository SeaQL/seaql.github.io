...
The `Related` trait is a representation of the arrows (1-1, 1-N, M-N) we draw on Entity Relationship Diagrams. A [`Linked`](https://docs.rs/sea-orm/0.6/sea_orm/entity/trait.Linked.html) is composed of a chain of relations, and is useful when:
...
Find fillings that can be filled into a cake with the [`find_linked`](https://docs.rs/sea-orm/0.6/sea_orm/entity/prelude/trait.ModelTrait.html#method.find_linked) method.
...
Find all pairs of cake and filling together in a single select with the [`find_also_linked`](https://docs.rs/sea-orm/0.6/sea_orm/entity/prelude/struct.Select.html#method.find_also_linked) method.
