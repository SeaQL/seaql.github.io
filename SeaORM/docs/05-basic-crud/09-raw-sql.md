...
You can paginate [`SelectorRaw`](https://docs.rs/sea-orm/2.0.0/sea_orm/struct.SelectorRaw.html) and fetch `Model` in batch.
...
You can execute an unprepared SQL statement with [`ConnectionTrait::execute_unprepared`](https://docs.rs/sea-orm/2.0.0/sea_orm/trait.ConnectionTrait.html#tymethod.execute_unprepared).
