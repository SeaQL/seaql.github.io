...
The [`DeriveActiveEnum`](https://docs.rs/sea-orm/2.0.0/sea_orm/derive.DeriveActiveEnum.html) macro implements the [`ActiveEnum`](https://docs.rs/sea-orm/2.0.0/sea_orm/entity/trait.ActiveEnum.html) trait under the hood.
