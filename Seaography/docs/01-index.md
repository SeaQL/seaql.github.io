...
1. [Why Seaography](01-introduction/01-seaography.md)

## Getting Started

1. [Bootstrap Project](02-getting-started/01-bootstrap.md)
2. [Project Structure](02-getting-started/02-project-structure.md)

## GraphQL Schema

1. [Data Types](03-graphql-schema/01-data-types.md)
2. [Simple Query](03-graphql-schema/02-simple-query.md)
3. [Query Filters](03-graphql-schema/03-filters.md)
4. [Relational Queries](03-graphql-schema/04-relational-query.md)
5. [Mutations](03-graphql-schema/05-mutation.md)

## Custom Endpoints

1. [Project Structure](04-custom-endpoints/01-project-structure.md)
2. [Custom Query](04-custom-endpoints/02-custom-query.md)
